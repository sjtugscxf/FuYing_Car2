...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  D:\GitHub_pository\FuYing_Car2\common\system_MK60DZ10.c
//    Command line =  
//        D:\GitHub_pository\FuYing_Car2\common\system_MK60DZ10.c -D LPLD_K60
...
//        ARM_MATH_CM4
//    List file    =  D:\GitHub_pository\FuYing_Car2\RAM\List\system_MK60DZ10.s
//
///////////////////////////////////////////////////////////////////////////////
...
// D:\GitHub_pository\FuYing_Car2\common\system_MK60DZ10.c
//    1 /**
...
SystemCoreClockUpdate:
        ...
        ANDS     R0,R0,#0x1F
        ADDS     R0,R0,#+24
        LDR.N    R1,??DataTable2_16  ;; 0x2faf080
        MULS     R0,R1,R0
//   91   temp = (uint32_t)(temp/((uint32_t)(MCG->C5 & MCG_C5_PRDIV_MASK) +1u ));
        LDR.N    R1,??DataTable2_17  ;; 0x40064004
        LDRB     R1,[R1, #+0]
